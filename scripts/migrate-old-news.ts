...
const oldNewsData = [
  {
    ...
    content: `On November 20, 2024, Maa Durga Seva Sansthan Trust launched a powerful Nasha Mukti Jagrukta Abhiyaan (Anti-Drug Awareness Campaign) across multiple villages in Dhanbad district. This comprehensive initiative aimed to educate youth and community members about the devastating effects of drug abuse and substance addiction, reaching over 500 participants.
...
async function migrateNews() {
  ...
  for (const news of oldNewsData) {
    try {
      ...
      console.error(`❌ Error migrating "${news.title}":`, error);
    }
  }

  console.log('\n✨ Migration completed!');
  console.log('📊 Check your admin panel at http://localhost:3000/admin/news');
}
